...
import type { ContactSubmission as _ContactSubmission, Subject as _Subject, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitContact(arg0: string, arg1: string, arg2: Subject, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContact(arg0, arg1, to_candid_Subject_n6(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "media" in value ? Subject.media : "partnership" in value ? Subject.partnership : "investment" in value ? Subject.investment : "general" in value ? Subject.general : value;
}
...
function to_candid_Subject_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Subject): _Subject {
    return to_candid_variant_n7(_uploadFile, _downloadFile, value);
}
function to_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Subject): {
    media: null;
} | {
    partnership: null;
} | {
    ...
    return value == Subject.media ? {
        media: null
    } : value == Subject.partnership ? {
        partnership: null
    } : value == Subject.investment ? {
        investment: null
